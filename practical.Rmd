...
4.  Dr D. R. Peterson of the Department of Epidemiology, University of Washington, collected the data found in file `np1.sav`.  It consists of the birth-weights of each of 20 dizygous twins.  The hypothesis to be tested is that the SIDS child of each pair has a lower birth-weight.     
...
wilcox.signtest(bw~SIDS,data=twins)
```
